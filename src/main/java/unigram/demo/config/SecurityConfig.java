package unigram.demo.config;



import unigram.demo.security.JwtAuthenticationEntryPoint;
import unigram.demo.security.JwtAuthenticationFilter;
import unigram.demo.service.impl.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(UserDetailsServiceImpl userDetailsService, JwtAuthenticationEntryPoint unauthorizedHandler , DataSource dataSource) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/baseimage/club/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/baseimage/announcement/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/baseimage/activity/**").permitAll()
                        .anyRequest().authenticated()
                ).rememberMe(rememberMe -> rememberMe
                        .tokenRepository(persistentTokenRepository())
                        .tokenValiditySeconds(86400) // 1 gün
